...
(module (type $0 (func)) (func $0 (type 0) (local f32 f32)))
(assert_malformed
...
(module (type $0 (func)) (func $0 (type 0)) (func $1 (type 0)))
(assert_malformed
  (module binary
    "\00\61\73\6d\01\00\00\00\01\04\01\60\00\00\03\03"
...
(module (type $0 (func)) (table $0 1 funcref) (func $0 (type 0)))
(assert_malformed
  (module binary
    "\00\61\73\6d\01\00\00\00\01\04\01\60\00\00\03\02"
...
(module
  ...
  (func $0
    (type 0)
    (block (i32.const 1) (if (then (i32.const 1) (br_table 2)) (else)))
  )
)
(assert_malformed
  (module binary
