...
(module)
(module)
(module (type $0 (func (param i32 i64) (result i32))))
(module (type $0 (func (param i32 i64) (result i32))))
(module
...
(module (type $0 (func)) (func $0 (type 0)))
(module (type $0 (func)) (func $0 (type 0)) (export "f1" (func 0)))
(module (type $0 (func)) (func $0 (type 0)) (export "f1" (func 0)))
(module (type $0 (func)) (func $0 (type 0)))
(module (global $0 i32 (i32.const 0)))
(module (global $0 i32 (i32.const -1)))
(module (global $0 i32 (i32.const 0)))
(module (global $0 i32 (i32.const -1)))
(module (global $0 i64 (i64.const 0)))
(module (global $0 i64 (i64.const -1)))
(module (global $0 i64 (i64.const 0)))
(module (global $0 i64 (i64.const -1)))
(assert_malformed
